...
if __name__ == '__main__':
    labelAdd = '/media/ting/新加卷/capstone/data/data_object_image/training/label_2'
    imageAdd = '/media/ting/新加卷/capstone/data/data_object_image/training/image_2'
    saveFileName = 'kitti_train.txt'
    saveFileDir = '/home/ting/software/capstone/train_kitti_carperson_xml/'
